%% Power Flow Assignment - Sajjad Uddin Mahmud - Fall 2022 - WSU
...
P_Load = xlsread('IEEE14_Formatted.xlsx','J3:J16')/Base_MVA; % Load MW pu
Q_Load = xlsread('IEEE14_Formatted.xlsx','K3:K16')/Base_MVA; % Load MVAR pu
P_Gen = xlsread('IEEE14_Formatted.xlsx','L3:L16')/Base_MVA; % Generator MW pu
Q_Gen = xlsread('IEEE14_Formatted.xlsx','M3:M16')/Base_MVA; % Generator MVAR pu

%% Reading from Branch Data
%% Branch Number
From_Bus = xlsread('IEEE14_Formatted.xlsx','A19:A38');
To_Bus = xlsread('IEEE14_Formatted.xlsx','B19:B38');
